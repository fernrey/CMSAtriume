...
const VersionView = ({ collection, global }) => {
    ...
    return (React.createElement("div", { className: baseClass },
        ...
        React.createElement("div", { className: `${baseClass}__wrap` },
            ...
            (doc === null || doc === void 0 ? void 0 : doc.version) && (React.createElement(RenderFieldsToDiff, { locales: locales.map(({ value }) => value), fields: fields, fieldComponents: fieldComponents, fieldPermissions: fieldPermissions, version: doc === null || doc === void 0 ? void 0 : doc.version, comparison: comparison })))));
};
